...
<body>
    ...
    <nav class="navbar navbar-expand-sm bg-secondary navbar-dark mb-5 text-white">
        <h5 class="text-uppercase">Welcome <?php  
    ...
    <div class="container">
        <div class="row">
            <?php
            $pquery = "SELECT `item_name`, `image`, `price` FROM item WHERE `category`='02' ORDER BY id ASC";
                    ...
                    <div class="col-md-3">
                        <form action="insert.php" method="POST">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <img src="img/mobiles/<?php echo $product['image'];  ?>" alt="mobile phone" class="img-fluid">
